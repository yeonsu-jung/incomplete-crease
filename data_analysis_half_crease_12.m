...
%%
file_path='/Users/yeonsu/Dropbox (Harvard University)/xray-data/z-stacks/zStack_HalfCrease_12/zstack.mat';
load(file_path)
%%
...
temp_center = [-7.4906,-40.28,51.24];
...
plot(az_bin(I_min+7:I_min+17),tmp(I_min+7:I_min+17),'ro-');
