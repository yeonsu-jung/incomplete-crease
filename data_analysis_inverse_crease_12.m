...
%%
file_path='/Users/yeonsu/Dropbox (Harvard University)/xray-data/z-stacks/zStack_InverseHalfCrease_12/zstack.mat';
load(file_path)
%%
...
for i = 1:num_R
    ...
    for j = 1:num_az
        ...
        if nnz(I_R&I) > 0
            binned_data(j,i) = mean(el(I_R&I&I_el));
            binned_data_min(j,i) = min(el(I_R&I&I_el));
            binned_data_max(j,i) = max(el(I_R&I&I_el));
        end
    end
end
