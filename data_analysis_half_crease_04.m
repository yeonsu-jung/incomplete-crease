...
%%
file_path='/Users/yeonsu/Dropbox (Harvard University)/xray-data/z-stacks/zStack_HalfCrease_04/zstack.mat';
load(file_path)
%%
...
temp_center = [-3.72,94.1676,113.128];
...
%%
head_tail_distance = norm(tail-head)*0.88;
...
%%
num_R = 35;
R_list = linspace(50,head_tail_distance*0.88,num_R);
delta_R = 1;
