...
%%
file_path='/Users/yeonsu/Dropbox (Harvard University)/xray-data/z-stacks/zStack_InverseHalfCrease_02/zstack.mat';
load(file_path)
%%
...
plot(az_bin(I_min+10:I_min+21),tmp(I_min+10:I_min+21),'ro-');
plot(az_bin(I_min-21:I_min-10),tmp(I_min-21:I_min-10),'bo-');
