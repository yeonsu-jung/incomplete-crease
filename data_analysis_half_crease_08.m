...
%%
file_path='/Users/yeonsu/Dropbox (Harvard University)/xray-data/z-stacks/zStack_HalfCrease_08/zstack.mat';
load(file_path)
%%
...
%%
[az0,el0,r0] = cart2sph(centered(:,1),centered(:,2),centered(:,3));
%%
...
plot3v(dip_positions,'o','linewidth',3);hold on;
plot3v(centered(1:500:end,:),'.');
%
...
%%
head_tail_distance = norm(tail-head)*0.95;
...
%%
num_R = 35;
R_list = linspace(50,head_tail_distance*0.95,num_R);
delta_R = 1;

close all;
for i = 1:num_R
    R = R_list(i);
    I_R = rwnorm(r.*cos(el) - R) < delta_R;
